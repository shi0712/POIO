...
export namespace MumbleServer
{
    ...
    type TreeList = MumbleServer.Tree[];
    ...
    class DBState
    {
        static readonly Normal:DBState;
        static readonly ReadOnly:DBState;
        
        static valueOf(value:number):DBState;
        equals(other:any):boolean;
        hashCode():number;
        toString():string;
    ...
    class ServerException extends iceNS0.Ice.UserException
    {
    }
     ...
     */
    class InvalidChannelException extends ServerException
    {
    }
     ...
     */
    class InvalidServerException extends ServerException
    {
    }
     ...
     */
    class ServerBootedException extends ServerException
    {
    }
     ...
     */
    class ServerFailureException extends ServerException
    {
    }
     ...
     */
    class InvalidUserException extends ServerException
    {
    }
     ...
     */
    class InvalidTextureException extends ServerException
    {
    }
     ...
     */
    class InvalidCallbackException extends ServerException
    {
    }
     ...
     */
    class InvalidSecretException extends ServerException
    {
    }
     ...
     */
    class NestingLimitException extends ServerException
    {
    }
     ...
     */
    class WriteOnlyException extends ServerException
    {
    }
     ...
     */
    class InvalidInputDataException extends ServerException
    {
    }
     ...
     */
    class InvalidListenerException extends ServerException
    {
    }
     ...
     */
    class ReadOnlyModeException extends ServerException
    {
    }
    ...
    abstract class ServerCallback extends iceNS0.Ice.Object
    {
         ...
         * @return The return value is always "::MumbleServer::ServerCallback".
         */
    ...
    abstract class ServerContextCallback extends iceNS0.Ice.Object
    {
        ...
        /**
         * Obtains the Slice type ID of this type.
         * @return The return value is always "::MumbleServer::ServerContextCallback".
         */
        static ice_staticId():string;
    }
    ...
    abstract class ServerAuthenticator extends iceNS0.Ice.Object
    {
        ...
        /**
         * Obtains the Slice type ID of this type.
         * @return The return value is always "::MumbleServer::ServerAuthenticator".
         */
        static ice_staticId():string;
    }
    ...
    abstract class ServerUpdatingAuthenticator extends iceNS0.Ice.Object
    {
        ...
        /**
         * Obtains the Slice type ID of this type.
         * @return The return value is always "::MumbleServer::ServerUpdatingAuthenticator".
         */
        static ice_staticId():string;
    }
    ...
    abstract class ServerPrx extends iceNS0.Ice.ObjectPrx
    {
         ...
         * @return The asynchronous result object for the invocation.
         */
        getTree(context?:Map<string, string>):iceNS0.Ice.AsyncResult<MumbleServer.Tree>;
        /**
         ...
         * @return The asynchronous result object for the invocation.
         */
        getListenerVolumeAdjustment(channelid:number, userid:number, context?:Map<string, string>):iceNS0.Ice.AsyncResult<number>;
        /**
         ...
         * @return The asynchronous result object for the invocation.
         */
        setListenerVolumeAdjustment(channelid:number, userid:number, volumeAdjustment:number, context?:Map<string, string>):iceNS0.Ice.AsyncResult<void>;
        /**
    ...
    abstract class Server extends iceNS0.Ice.Object
    {
         ...
         * @return The result or a promise like object that will be resolved with the result of the invocation.
         */
        abstract getTree(current:iceNS0.Ice.Current):PromiseLike<MumbleServer.Tree>|MumbleServer.Tree;
        /**
         * Per-server interface. This includes all methods for configuring and altering
         * the state of a single virtual server. You can retrieve a pointer to this interface
         * from one of the methods in {@link Meta}.
         ...
         * @return The result or a promise like object that will be resolved with the result of the invocation.
         */
        abstract getListenerVolumeAdjustment(channelid:number, userid:number, current:iceNS0.Ice.Current):PromiseLike<number>|number;
        /**
         * Per-server interface. This includes all methods for configuring and altering
         * the state of a single virtual server. You can retrieve a pointer to this interface
         * from one of the methods in {@link Meta}.
         ...
         * @return The result or a promise like object that will be resolved with the result of the invocation.
         */
        abstract setListenerVolumeAdjustment(channelid:number, userid:number, volumeAdjustment:number, current:iceNS0.Ice.Current):PromiseLike<void>|void;
        /**
         * Per-server interface. This includes all methods for configuring and altering
         * the state of a single virtual server. You can retrieve a pointer to this interface
         * from one of the methods in {@link Meta}.
        ...
        /**
         * Obtains the Slice type ID of this type.
         * @return The return value is always "::MumbleServer::Server".
         */
        static ice_staticId():string;
    }
    ...
    abstract class MetaCallback extends iceNS0.Ice.Object
    {
        ...
        /**
         * Obtains the Slice type ID of this type.
         * @return The return value is always "::MumbleServer::MetaCallback".
         */
        static ice_staticId():string;
    }
    ...
    abstract class MetaPrx extends iceNS0.Ice.ObjectPrx
    {
         ...
         * @return The asynchronous result object for the invocation.
         */
        getAssumedDatabaseState(context?:Map<string, string>):iceNS0.Ice.AsyncResult<DBState>;
        /**
         * Sets the assumed state of the underlying database
         * @param context The Context map to send with the invocation.
         * @return The asynchronous result object for the invocation.
         */
        setAssumedDatabaseState(state:DBState, context?:Map<string, string>):iceNS0.Ice.AsyncResult<void>;
    ...
    abstract class Meta extends iceNS0.Ice.Object
    {
         ...
         * @return The result or a promise like object that will be resolved with the result of the invocation.
         */
        abstract getAssumedDatabaseState(current:iceNS0.Ice.Current):PromiseLike<DBState>|DBState;
        /**
         * This is the meta interface. It is primarily used for retrieving the {@link Server} interfaces for each individual server.
         * @param current The Current object for the invocation.
         * @return The result or a promise like object that will be resolved with the result of the invocation.
         */
        abstract setAssumedDatabaseState(state:DBState, current:iceNS0.Ice.Current):PromiseLike<void>|void;
        /**
         * Obtains the Slice type ID of this type.
         * @return The return value is always "::MumbleServer::Meta".
         */
        static ice_staticId():string;
    }
}
